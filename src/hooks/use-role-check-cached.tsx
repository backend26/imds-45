...
export const useJournalistCheckCached = () => {
  return useRoleCheckCached({ allowedRoles: ['administrator', 'journalist'] });
};
...
export const useJournalistCheck = () => useRoleCheckCached({ allowedRoles: ['administrator', 'journalist'] });
