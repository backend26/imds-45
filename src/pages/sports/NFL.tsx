...
export default function NFL() {
  ...
  // Filter articles for NFL
  const nflArticles = mockArticles.filter(article => 
    article.category.toLowerCase() === 'nfl'
  );

  const featuredArticles = nflArticles.slice(0, 3);
  const otherArticles = nflArticles.slice(3);
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            ...
            draft e tutto il football americano.
          </p>
        </div>
