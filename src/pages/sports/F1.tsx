...
export default function F1() {
  ...
  // Filter articles for F1
  const f1Articles = mockArticles.filter(article => 
    article.category.toLowerCase() === 'f1'
  );

  const featuredArticles = f1Articles.slice(0, 3);
  const otherArticles = f1Articles.slice(3);
