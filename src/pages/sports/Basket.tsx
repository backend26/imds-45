...
export default function Basket() {
  ...
  // Filter articles for basketball
  const basketArticles = mockArticles.filter(article => 
    article.category.toLowerCase() === 'basket'
  );

  const featuredArticles = basketArticles.slice(0, 3);
  const otherArticles = basketArticles.slice(3);
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            Le ultime notizie da NBA, EuroLega, Serie A e tutto il mondo 
            della pallacanestro italiana e internazionale.
          </p>
        </div>
